...
function LiveBetsCard(props) {
  const [data, setData] = useState("");

  useEffect(() => {
    // var newData = Array.from(props.matches.match);
    // var newdata = Object.entries(props.matches);
  ...
  return (
    <>
      <div className="league">
        <div className="league-name">{props.name}</div>
      ...
      <div className="league-details">
        <div className="league-match">
          <div className="league-team">
            ...
            <div className="league-team-score">
              {/* <p className="league-team-score-stat">3</p>
              <p className="league-team-score-stat"></p> */}
            </div>
          </div>
          <div className="league-team">
  ...
  return (
    <>
      <div className="livebets-nam">
        ...
        {/* {console.log(props.bookmakers["0"].odds)} */}
        {moreOdd === "show-odd"
